...
docker exec mysql-parkrun-stats mysql parkrun_stats -h127.0.0.1 -uschema -pfractal -e \
...
docker exec mysql-parkrun-stats mysql parkrun_stats_test -h127.0.0.1 -uschema -pfractal -e \
  "`cat mysql/scripts/create-database-and-tables.sql`"
